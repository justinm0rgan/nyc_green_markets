...
We see its a data frame with 48 records and 9 columns. We pre-processed it to have separate coordinate columns so we could show how to use these to transform to a **sf** object 
...
Looks great, now we can join it with NYC boundary data, and start creating some basic visualizations. 

## Spatial Join with Community Districts
...
Now we can summarize the data frame to count how many GROW NYC markets are in each CD.
